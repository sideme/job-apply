...
describe("TailoringEditor", () => {
  ...
  it("does not expose legacy tracer-link controls", async () => {
    render(
      <TailoringEditor
    ...
    expect(screen.queryByText("Tracer Links")).not.toBeInTheDocument();
    expect(
      screen.queryByLabelText("Enable tracer links for this job"),
