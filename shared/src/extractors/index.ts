...
export interface ExtractorSourceMetadata {
  label: string;
  order: number;
  category: "pipeline" | "manual" | "legacy";
...
> = {
  ...
  glassdoor: { label: "Glassdoor", order: 40, category: "legacy" },
  ukvisajobs: {
    label: "UK Visa Jobs",
    order: 50,
    category: "legacy",
  ...
  hiringcafe: { label: "Hiring Cafe", order: 70, category: "legacy" },
  startupjobs: { label: "startup.jobs", order: 80, category: "legacy" },
