...
export interface Job {
  ...
  datePostedCheckedAt: string | null; // Last detail-page time extraction attempt
  ...
  keywordMissing: string | null; // JSON array of canonical skill names
